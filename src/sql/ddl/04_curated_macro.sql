...
CREATE INDEX IF NOT EXISTS idx_cur_macro_available_time ON cur_macro_observations(available_time);
CREATE INDEX IF NOT EXISTS idx_cur_macro_period_end ON cur_macro_observations(period_end);
...
CREATE INDEX IF NOT EXISTS idx_cur_macro_releases_series_time ON cur_macro_releases(series_id, release_time);
CREATE INDEX IF NOT EXISTS idx_cur_macro_releases_available_time ON cur_macro_releases(available_time);
