...
class MetricsCollector:
    ...
    def timer(self, name: str, value_ms: float, tags: Optional[Dict[str, str]] = None):
        """Record timer value."""
        full_name = f"{self.namespace}.{name}"
...
class PipelineMetrics:
    ...
    def record_error(self, error_type: str):
        ...
        self.metrics.counter(
            "errors",
            1,
            {**self.base_tags, "error_type": error_type}
        )
    ...
    def time_operation(self, operation: str):
        ...
        return self.metrics.timer_context(
            ...
            {**self.base_tags, "operation": operation}
        )
