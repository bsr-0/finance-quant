    ...
    def select_markets(self, max_markets: int | None = None) -> list[dict]:
        ...
        if self.universe_mode == "explicit_list" and self.explicit_markets:
            ...
            while True:
                ...
                if len(batch) < 20:
                    break
                if self.universe_mode == "top_volume" and max_markets is not None and len(markets) >= max_markets:  # noqa: E501
                    break
            ...
            try:
                ...
                if trades:
                    ...
                    if "timestamp" in trades_df.columns:
                        trades_df["timestamp"] = pd.to_datetime(trades_df["timestamp"], unit="s", utc=True)  # noqa: E501
